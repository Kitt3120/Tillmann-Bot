package de.vanillekeks.tillmannbot.musixmatch;

import com.google.gson.Gson;
import com.google.gson.JsonParseException;
import de.vanillekeks.tillmannbot.musixmatch.config.Constants;
import de.vanillekeks.tillmannbot.musixmatch.config.Methods;
import de.vanillekeks.tillmannbot.musixmatch.config.StatusCode;
import de.vanillekeks.tillmannbot.musixmatch.entity.error.ErrorMessage;
import de.vanillekeks.tillmannbot.musixmatch.entity.lyrics.Lyrics;
import de.vanillekeks.tillmannbot.musixmatch.entity.lyrics.get.LyricsGetMessage;
...
import de.vanillekeks.tillmannbot.musixmatch.entity.track.get.TrackGetMessage;
import de.vanillekeks.tillmannbot.musixmatch.entity.track.search.TrackSeachMessage;
import de.vanillekeks.tillmannbot.musixmatch.http.MusixMatchRequest;
import de.vanillekeks.tillmannbot.musixmatch.snippet.Snippet;
import de.vanillekeks.tillmannbot.musixmatch.snippet.get.SnippetGetMessage;
import de.vanillekeks.tillmannbot.musixmatch.subtitle.Subtitle;
import de.vanillekeks.tillmannbot.musixmatch.subtitle.get.SubtitleGetMessage;
...
public class MusixMatch {
	...
	private void handleErrorResponse(String jsonResponse)
		...
		ErrorMessage errMessage = gson.fromJson(jsonResponse,
				ErrorMessage.class);
		int responseCode = errMessage.getMessageContainer().getHeader().getStatusCode();
